...
const root = path.join(__dirname, '..', 'src/app/(app)/accounts');
...
fs.writeFileSync(path.join(root, 'AccountsClient.tsx'), clientCode);

const pageCode = `import * as React from 'react';
...
fs.writeFileSync(path.join(root, 'page.tsx'), pageCode);
console.log('Successfully wrote AccountsClient.tsx and page.tsx');
