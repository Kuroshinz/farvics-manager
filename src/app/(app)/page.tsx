  ...
  return (
    <div className="space-y-8 animate-fade-in">
      <div className="space-y-2">
        <Typography variant="h1" className="bg-clip-text text-transparent bg-gradient-to-r from-white via-white/90 to-white/50">
          Intelligence Overview
        </Typography>
        <Typography variant="body" className="text-content-secondary max-w-2xl leading-relaxed">
          Your centralized command center. Monitor liquidity flows, operational runway, and AI-driven projections in real-time.
        </Typography>
      </div>
      
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <GlassPanel className="p-8 group cursor-default">
