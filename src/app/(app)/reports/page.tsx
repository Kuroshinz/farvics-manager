...
import { fetchReports } from '../../actions/financial-queries';
  ...
  return (
    <div className="space-y-6 md:space-y-8 h-full animate-fade-in pb-20">
      <PageHeader 
        ...
        description="Generated historical statements and predictive models."
        breadcrumbs={[{ label: 'Farvics HQ' }, { label: 'Financial' }, { label: 'Financial Reports' }]}
      />
