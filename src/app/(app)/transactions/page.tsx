...
import { fetchTransactions } from '../../actions/financial-queries';
  ...
  return (
    <div className="space-y-6 md:space-y-8 h-full animate-fade-in pb-20">
      <PageHeader 
        ...
        description="Immutable ledger of all incoming and outgoing capital flows."
        breadcrumbs={[{ label: 'Farvics HQ' }, { label: 'Financial' }, { label: 'Transaction Ledger' }]}
      />
